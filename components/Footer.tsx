                            ...
                            {localActive == 'en' ? (
                                <>
                                    <div className="col-span-4 lg:col-span-2">
                                        ...
                                        <h1 className="pr-[110px] text-white text-[40px] font-bold ite uppercase relative mb-[25px] w-fit"  >{localActive == 'en' ? 'Road Assistant' : 'مساعد الطريق'}<span className="block w-[50px]  translate-x-[-50%] left-[50%] h-[4px] bg-secoColor absolute bottom-[-1px] translate-y-[6px] rounded-[3px]"></span></h1>
                                ...
                                <>
                                    ...
                                    {footerLinks.map((section, index) => (
                                        <div key={index} className={`row-links col-span-4 sm:col-span-2 lg:col-span-1 ${localActive == 'ar' ? "text-right" : ""}`}>
                                            <h6 className="capitalize text-[21px] font-[700] mb-[22px]">{section.title}</h6>
                                            <ul className="footer-info">
                                                {section.links.map((link, linkIndex) => (
                                                    <li key={linkIndex} className='text-[#cbcbcb] mb-3 text-[18px] leading-[1.5]'>
