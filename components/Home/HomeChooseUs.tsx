            ...
            <div className="home3-about-bg pb-[170px] pt-[125px] bg-no-repeat pt-125 pb-170 bg-cover" style={{ backgroundImage: 'url("home3-about-bg.png")' }}>
                <div className="container">
                    <div className={`flex flex-col pt-90 ${localActive=='ar'?'reflect-dir':''}`}>
                        <div className="w-full pt-[140px] md:pt-[70px]">
                            <div className="mb-8 lg:mb-0 lg:mr-12 aos-init aos-animate" data-aos="fade-up" data-aos-duration="2000" >
                                <div className="title">
                        ...
                        <div className="mb-10 lg:mb-0 flex justify-end aos-init aos-animate" data-aos="fade-up" data-aos-duration="2000">
                            <AboutFeats/>
                        </div>
                    </div>
                </div>
