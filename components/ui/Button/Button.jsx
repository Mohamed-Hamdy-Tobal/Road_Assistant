...
import { CONTROL_SIZES, SIZES } from "../util/constants"
            ...
            case SIZES.LG:
                sizeClass = classNames(
                    ...
                    icon && !children
                        ...
                        : `${customPadding ? customPadding : 'px-8 py-2'} text-base`
                )
                break
            case SIZES.SM:
                sizeClass = classNames(
                    ...
                    icon && !children
                        ...
                        : `${customPadding ? customPadding : 'px-3 py-2'} text-sm`
                )
                break
            case SIZES.XS:
                sizeClass = classNames(
                    ...
                    icon && !children
                        ...
                        : `${customPadding ? customPadding : 'px-3 py-1'} text-xs`
                )
                break
            default:
                sizeClass = classNames(
                    ...
                    icon && !children
                        ...
                        : `${customPadding ? customPadding : 'px-8 py-2'}`
                )
                break
        }
        return sizeClass
